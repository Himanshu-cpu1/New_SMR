...
public class Remove_Ip_Restriction_In_Admin extends Login_Admin  {
    ...
    public void Click_On_Update_Ip_Range() throws InterruptedException {
        ...
        Enter_Ip_Range.sendKeys("152.59.146.158");
    ...
    public void Updated_succesfully() throws InterruptedException {
        ...
        Assert.assertEquals(Actual_message, Uppdated,"Ip restrication Removed succesfully");
