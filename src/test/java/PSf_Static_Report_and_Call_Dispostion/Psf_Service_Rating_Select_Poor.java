...
public class Psf_Service_Rating_Select_Poor extends LOGINs {
	...
	//.................................................................................................
			...
			@Test(priority = 16)
			public void Check_Call_Dispostion_Service_Rating__Poor() throws InterruptedException {
		...
		//...............................................................................................
		        ...
		        Thread.sleep(1000); 
		        WebElement Select_Average = driver.findElement(By.xpath("//*[text()=\"Poor\"]"));
		        ...
		        Save_Succesfully("Poor Complaint generated successfully.");
			        ...
			        Thread.sleep(1000);
				     ...
				     // Split the text by newline and take the first part
				       CCERemark = CCERemark.split("\n")[0];
				        ...
				        Assert.assertEquals(CCERemark, Reg_NO, " Poor, Customer is not in open Complaint tab");
				}
...
//				    	               .click(Choose_File)
				    	...
				    	public void Customer_Will_Be_Available_In_Resolved_Complaints() throws InterruptedException, AWTException {
					        ...
					        Assert.assertEquals(CCERemark3, CCERemark2, "Resolved Complaints - Customer  is not present in Resolved Complaints  Tab");
